...
import 'package:flutter_map_booking/Screen/Notification/Apis/NotificationApi.dart';
...
class AppRoute {
  ...
  static const String bookingDetailWidget='/booking';
  static const String apinotification ='/apinotification';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case bookingDetailWidget:
      return PageViewTransition(builder: (_)=> BookingDetailWidget());
      case apinotification:
      return PageViewTransition(builder:(_)=>ApiNotification());
      default:
