          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  title: Text(widget.placeBloc!.listPlace![index].name.toString()),
                  subtitle: Text(widget.placeBloc!.listPlace![index].formattedAddress.toString()),
                  onTap: () {
                  ...
                  children: <Widget>[
                    TextField(
                      ...
                      controller: TextEditingController.fromValue(
                        TextEditingValue(
                          text: formLocation.toString() != null ? formLocation.toString() :'',
                          selection: TextSelection.collapsed(
                            offset: formLocation.toString() != null ? formLocation.toString().length : 0),
                        ),
                      ),
...
//                                  ):SizedBox.shrink()
                      ...
                      controller: TextEditingController.fromValue(
                        TextEditingValue(
                          text: toLocation.toString() != null ? toLocation.toString() :'',
                          selection: TextSelection.collapsed(
                              offset: toLocation.toString() != null ? toLocation.toString().length : 0),
                        ),
                      ),
                      onChanged: (String value) async {
                        toLocation = value;
                ...
                child: InkWell(
                  onTap:(){
                    // Navigator.pop(context);
                     Navigator.of(context).pushNamed(AppRoute.bookingDetailWidget); 
