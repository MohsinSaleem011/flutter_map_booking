...
import 'package:flutter_map_booking/Screen/Directions/widgets/select_service_widget.dart';
...
zoom: 14,
  ...
  Widget build(BuildContext context) {
    Controller home=Get.find<Controller>();
    return Scaffold(
      body:Stack(
children: [
   GoogleMap(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Container(
                          ...
                          child: InkWell(
                            onTap: (){
                              Navigator.of(context).push(MaterialPageRoute(builder: (_)=>SelectServiceWidget()));
                            },
